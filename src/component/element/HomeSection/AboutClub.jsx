        ...
        <div className="club_section lg:max-w-[1100px] w-full mx-auto lg:grid grid-cols-5">
          ...
          <div className="club_content col-span-2 lg:flex flex-col justify-center items-center">
            <div>
              ...
              <h2 className="mb-4">welcome to aj sport academy</h2>
              <p className="text-[16px] text-gray font-medium text-justify mb-2">
                ...
                interact with young people between ages 5-23! We aim to develop
                young players’ skills/abilities to a higher level and offer
                trials throughout our numerous football scouts and network
                relations with clubs and pro clubs around the world.
              </p>
